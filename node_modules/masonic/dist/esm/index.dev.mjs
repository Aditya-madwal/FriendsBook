...
function usePositioner(_ref, deps) {
  ...
  var initPositioner = () => {
    var [computedColumnWidth, computedColumnCount] = getColumns(width, columnWidth, columnGutter, columnCount, maxColumnCount);
  ...
  var opts = [width, columnWidth, columnGutter, rowGutter, columnCount, maxColumnCount];
...
var getColumns = function getColumns(width, minimumWidth, gutter, columnCount, maxColumnCount) {
  if (width === void 0) {
    width = 0;
  }
